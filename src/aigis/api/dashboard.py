...
def dashboard():
    # Static UI; data is fetched via authenticated API calls from the browser.
    html_doc = """
    <!doctype html>
    <html>
      <head>
        ...
        <style>
          ...
          * { box-sizing: border-box; }
          ...
          .section-title { font-size: 12px; text-transform: uppercase; color: var(--muted); margin: 8px 0; }
          .input {
            width: 100%;
            padding: 8px 10px;
            border-radius: 8px;
