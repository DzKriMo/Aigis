...
class Settings:
    def __init__(self):
        ...
        self.database_url = _get("DATABASE_URL", "sqlite:///aigis.db")
        ...
        self.aigis_db_enabled = _get_bool("AIGIS_DB_ENABLED", True)
        ...
        self.jwt_secret = _get("AIGIS_JWT_SECRET", "dev-secret-change")
        self.jwt_issuer = _get("AIGIS_JWT_ISSUER", "aigis")
        self.jwt_exp_minutes = _get_int("AIGIS_JWT_EXP_MINUTES", 120)
        self.otel_enabled = _get_bool("AIGIS_OTEL_ENABLED", False)
